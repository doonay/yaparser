...
class LinksCollector:
    ...
    def _open_page(self, request):
        ...
        self.driver.find_element(By.CLASS_NAME, 'input__control').send_keys(request)
...
if __name__ == "__main__":
    ...
    grabber.run(city=city, district=district, type_org_ru=type_org_mapping[type_org], type_org=type_org)
    '''
